...
export default function PortfolioNavbar() {
  ...
  return (
    <Navbar
      fluid
      className="fixed top-0 text-blue-400 w-full z-50 border-b border-gray-100 bg-white/80 backdrop-blur-md px-4 py-3"
    >
        ...
        {navLinks.map((link) => (
          <NavbarLink
            ...
            className={`text-base font-bold py-3 md:py-0 transition-all duration-300 
              ${
                activeTab === link.name
                  ? "text-white md:border-b-2 md:border-blue-600"
